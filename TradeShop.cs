...
static class TradeShop
{
    ...
    public static void TradeShopOG(Player player)
    {
        ...
        while (running_shop)
        {
            ...
            Console.Clear();
            {
                ...
                {
                    Console.WriteLine("Invalid input"); // choice buy or sell;
                }
            }
        }
    }
        ...
        while (Selling)
        {
            ...
            if (int.TryParse(id, out int trade_id))
            {
                foreach (var weapon in player.PlayerInventory.WeaponInventory)
                {
...

                    {
                        ...
                        while (confirmation_sell)
                        {
                            ...
                            if (yes_no == "Y")
                            {
                                ...
                                player.RemoveItemFromInventory(null, World.WeaponByID(weapon.ID));
                    ...
                    {
                        Console.WriteLine("You dont have this weapon.");
                        Console.WriteLine("[Enter]");
                        Console.ReadLine();
                        Console.Clear();
                        Selling = false;
    ...
    public static void BuyWeapon(Player player)
    {
        ...
        while (Buying)
        {
            ...
            {
                Console.WriteLine("invalid input not int of any ");
                Buying = false; // tryparse; 64
            }

        }
    }
    public static void BuyConsumable(Player player)
    {
        bool Buying = true;
        while (Buying)
        {
            ...
            if (int.TryParse(id, out int buy_id))
            {
                foreach (var consumable in World.Consumables)
                {
                    ...
                    {
                        if (player.Coins >= consumable.Price)
                        {
                            if (!player.PlayerInventory.ConsumableInventory.Contains(consumable))
                            {
                            ...
                            {
                                Console.WriteLine("--------------------------------------");
                                Console.WriteLine("You already own this Consumable.");
                                Console.WriteLine("--------------------------------------");
                                Console.WriteLine("[Enter]");
                                Console.ReadLine();
                                Console.Clear();
                        ...
                        {
                            Console.WriteLine("--------------------------------------");
                            Console.WriteLine("You don't have enough money for this Consumable");
                            Console.WriteLine("--------------------------------------");
                            Console.WriteLine("[Enter]");
                            Console.ReadLine();
                            Console.Clear();
